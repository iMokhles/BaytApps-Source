...
- (void)initComponents {
    ...
    NSMutableArray *titlesMutableArray = [NSMutableArray new];
    for (NSInteger i = 1; i <= self.titlesNumbers; i++) {
        [titlesMutableArray addObject:[NSString stringWithFormat:@"%li", (long)i]];
    }
    self.titles = titlesMutableArray.copy;//@[@"1", @"2", @"3", @"4", @"5", @"6", @"7"];
...
//	NSAssert(_titlesNumbers == 0, @"titles not set");
//	NSAssert(_titlesNumbers > 2, @"titles must have 3 items at least");
...
- (void)setTitlesNumbers:(NSInteger)titlesNumbers {
    _titlesNumbers = titlesNumbers;
    NSMutableArray *titlesMutableArray = [NSMutableArray new];
    for (NSInteger i = 1; i <= _titlesNumbers; i++) {
        [titlesMutableArray addObject:[NSString stringWithFormat:@"%li", (long)i]];
    }
    self.titles = titlesMutableArray.copy;
    [self refreshDisplay];
}
