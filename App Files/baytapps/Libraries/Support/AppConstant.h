...
#define		PF_USER_FULLNAME_LOWER				@"fullnameLower"		//	String
#define		PF_USER_SUPPORT_STATUS				@"supportStatus"		//	String
#define		PF_USER_SUPPORT_TEAM				@"supportTeam"          //	String
...
#define		PF_Update_Noti                      @"PF_Update_Noti"				//	Number
...
#define     NOTIFICATION_TO_LOAD_RECENTS        @"NCGotNewMessageNotification"

#define     NOTIFICATION_TO_DOWNLOAD_APP        @"NCGotNewAppStatusMessageNotification"
