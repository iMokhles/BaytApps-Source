...
- (UIImage*)imageWithString:(NSString*)str
{
    ...
    label.textColor = [UIColor blackColor];//[[CLImageEditorTheme theme] toolbarColor];
...
- (void)initInfoPanel
{
    ...
    */
    ...
    [_chainBtn setImage:[[CLImageEditorTheme imageNamed:[CLResizeTool class] image:@"btn_chain_on.png"] imageTintedWithColor:[UIColor blackColor]] forState:UIControlStateSelected];
	...
	[_fieldW setTextColor:[UIColor blackColor]];
	...
	[_fieldH setTextColor:[UIColor blackColor]];
